...
#[must_use]
pub fn top_strengths_and_concerns(evidence: &[EvidenceItem], n: usize) -> (Vec<EvidenceItem>, Vec<EvidenceItem>) {
    ...
    strengths.sort_by(|a, b| (a.module.as_str(), a.code.as_str()).cmp(&(b.module.as_str(), b.code.as_str())));
    concerns.sort_by(|a, b| (a.module.as_str(), a.code.as_str()).cmp(&(b.module.as_str(), b.code.as_str())));
